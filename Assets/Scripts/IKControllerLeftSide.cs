...
public class IKControllerLeftSide : MonoBehaviour
{
    ...
    {
        float minX = originalPosition.x;
        float maxX = originalPosition.x + moveAreaWidth / 2f;
        float minY = originalPosition.y;
